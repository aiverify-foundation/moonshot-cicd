...
def generate_expected_llm_provider_entity_dict(
    provider_name: str,
    *,
    ...
    if system_name is None:
        system_name = provider_name.lower().replace(" ", "_")
    return {
...
class TestLLMProviderAdapter:
    ...
    def test_model_to_entity(self, llm_provider_adapter):
        ...
        # Arrange
        sqlalchemy_model = LLMProviderModel(
            id=1, name="test_provider", system_name="test_provider", version=0
        )
        ...
        # Assert
        expected_llm_provider_entity_dict = generate_expected_llm_provider_entity_dict(
            provider_name="test_provider", system_name="test_provider", version=0
        )
    ...
    def test_adding_providers(self, llm_provider_adapter):
        ...
        expected_llm_provider_a_entity_dict: dict[str, any] = generate_expected_llm_provider_entity_dict(
            expected_llm_provider_a, system_name="provider_a", version=0
        )

        expected_llm_provider_b: str = "provider_b"
        expected_llm_provider_b_entity_dict: dict[str, any] = generate_expected_llm_provider_entity_dict(
