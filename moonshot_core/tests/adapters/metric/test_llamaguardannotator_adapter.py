...
class TestLlamaGuardAnnotatorAdapter:
    ...
    def test_get_metric_connectors_failure(
        self, monkeypatch, mock_metric_config
    ):
    ...
    async def test_get_individual_result_safe(
        ...
        result = await adapter.get_individual_result(
            mock_metric_individual_entity
        )
    ...
    async def test_get_individual_result_no_connector(
        ...
        with pytest.raises(
            ...
            await adapter.get_individual_result(
                mock_metric_individual_entity
            )
