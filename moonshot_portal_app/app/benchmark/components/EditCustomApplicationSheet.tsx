          ...
          <div className="flex-1 min-h-0 overflow-y-auto space-y-6 pb-6">
            <SheetHeader className="p-0">
              ...
              <SheetDescription className="sr-only">
                Configure the custom application endpoints and settings.
              </SheetDescription>
            </SheetHeader>
            ...
            <Card className="py-0 gap-0">
              <CardContent className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {apiKeyConfigured ? (
                    <p className="text-sm text-gray-600">
                      Your secret has already been saved. No further action is needed unless you would like to replace it with a new one.
                    </p>
                  ) : null}
                </div>
              </CardContent>
